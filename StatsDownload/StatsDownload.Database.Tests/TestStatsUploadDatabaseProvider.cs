namespace StatsDownload.Database.Tests
{
    ...
    public class TestStatsUploadDatabaseProvider
    {
        ...
        public void SetUp()
        {
            ...
            systemUnderTest = NewStatsUploadDatabaseProvider(databaseConnectionSettingsServiceMock,
        ...
        public void Constructor_WhenNullDependencyProvided_ThrowsException()
        {
            Assert.Throws<ArgumentNullException>(
                () =>
                    NewStatsUploadDatabaseProvider(null, databaseConnectionServiceFactoryMock, loggingServiceMock,
                        errorMessageServiceMock));
            Assert.Throws<ArgumentNullException>(
                () =>
                    NewStatsUploadDatabaseProvider(databaseConnectionSettingsServiceMock, null, loggingServiceMock,
                        errorMessageServiceMock));
            Assert.Throws<ArgumentNullException>(
                () =>
                    NewStatsUploadDatabaseProvider(databaseConnectionSettingsServiceMock,
        ...
        {
            return new StatsUploadDatabaseProvider(databaseConnectionSettingsService,

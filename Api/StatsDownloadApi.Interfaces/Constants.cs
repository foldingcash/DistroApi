    ...
    public class Constants
    {
        ...
        public static class ErrorMessages
        {
            ...
            public static string EndDateInvalidMessage =>
                $"The end date is invalid, ensure the end date was provided as a query parameter in the format MM-DD-YYYY and greater than or equal to {DateTime.MinValue.Date:MM-dd-yyyy}.";

            public static string StartDateInvalidMessage =>
                $"The start date is invalid, ensure the start date was provided as a query parameter in the format MM-DD-YYYY and greater than or equal to {DateTime.MinValue.Date:MM-dd-yyyy}.";
        }
    }
}